...
![The extension running on a poe.ninja build: one click, price badges appearing
over the items, and the side panel counting the build up as the pass
finishes](docs/demo.gif)
